...
def encryption_view(request):
    ...
    return render(request, 'encryption.html', {'message': message, 'encrypted_image': encrypted_image})
def decryption_view(request):
    ...
    if request.method == "POST":
        ...
        if image.format not in supported_formats:
            return render(request, 'decryption_form.html', {'error_message': 'Unsupported image format'})
    ...
    return render(request, 'decryption_form.html', {'text': text})
